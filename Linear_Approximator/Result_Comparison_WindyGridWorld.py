...
sarsa = np.load('/Users/Riashat/Documents/PhD_Research/BASIC_ALGORITHMS/My_Implementations/Project_652/Code/Linear_Approximator/WindyGridWorld_Results/SARSA.npy')
q_learning = np.load('/Users/Riashat/Documents/PhD_Research/BASIC_ALGORITHMS/My_Implementations/Project_652/Code/Linear_Approximator/WindyGridWorld_Results/Q_Learning.npy')
expected_sarsa = np.load('/Users/Riashat/Documents/PhD_Research/BASIC_ALGORITHMS/My_Implementations/Project_652/Code/Linear_Approximator/WindyGridWorld_Results/Expected_SARSA.npy')
tb_2 = np.load('/Users/Riashat/Documents/PhD_Research/BASIC_ALGORITHMS/My_Implementations/Project_652/Code/Linear_Approximator/WindyGridWorld_Results/Two_Step_Tree_Backup.npy')
tb_3 = np.load('/Users/Riashat/Documents/PhD_Research/BASIC_ALGORITHMS/My_Implementations/Project_652/Code/Linear_Approximator/WindyGridWorld_Results/Three_Step_Tree_Backup.npy')
q_sigma_on_policy = np.load('/Users/Riashat/Documents/PhD_Research/BASIC_ALGORITHMS/My_Implementations/Project_652/Code/Linear_Approximator/WindyGridWorld_Results/Q(sigma)_On_Policy.npy')
q_sigma_off_policy = np.load('/Users/Riashat/Documents/PhD_Research/BASIC_ALGORITHMS/My_Implementations/Project_652/Code/Linear_Approximator/WindyGridWorld_Results/Off_Policy_Q_Sigma.npy')
q_sigma_off_policy_2 = np.load('/Users/Riashat/Documents/PhD_Research/BASIC_ALGORITHMS/My_Implementations/Project_652/Code/Linear_Approximator/WindyGridWorld_Results/Off_Policy_Q_Sigma_2_Step.npy')
# q_sigma_off_policy_3 = np.load('/Users/Riashat/Documents/PhD_Research/BASIC_ALGORITHMS/My_Implementations/Project_652/Code/Linear_Approximator/WindyGridWorld_Results/Off_Policy_Q_Sigma_3_Step.npy')
...
def multiple_plot_episode_stats(stats1, stats2, stats3,  stats4, stats5, stats6, stats7, smoothing_window=200, noshow=False):
    ...
    plt.xlabel("Epsiode")
    plt.ylabel("Epsiode Reward (Smoothed)")
    plt.title("Comparing Multi-Step TD Learning Algorithms - Windy Grid World Environment")  
    plt.show()
...
def main():
    ...
    multiple_plot_episode_stats(sarsa, q_learning , expected_sarsa, tb_2, tb_3, q_sigma_on_policy, q_sigma_off_policy)
